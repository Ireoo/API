...
class DB {
    ...
    ensureIndex(where, other = {}) {
        return new Promise((resolve, reject) => {
            this.mongo.ensureIndex(where, other, (error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    reIndex() {
        return new Promise((resolve, reject) => {
            this.mongo.reIndex((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    dropIndex(index) {
        return new Promise((resolve, reject) => {
            this.mongo.dropIndex(index, (error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    dropIndexes() {
        return new Promise((resolve, reject) => {
            this.mongo.dropIndexes((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    getIndexes() {
        return new Promise((resolve, reject) => {
            this.mongo.getIndexes((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    listCollections() {
        return new Promise((resolve, reject) => {
            this.mongo.listCollections((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    getCollectionNames() {
        return new Promise((resolve, reject) => {
            this.mongo.getCollectionNames((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    dropDatabase() {
        return new Promise((resolve, reject) => {
            this.mongo.dropDatabase((error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    addUser(usr) {
        return new Promise((resolve, reject) => {
            this.mongo.addUser(usr, (error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
    ...
    removeUser(username) {
        return new Promise((resolve, reject) => {
            this.mongo.removeUser(username, (error, result) => {
                if (this.debug) console.log("[ output ] ->", error ? error : JSON.stringify(result));
                error ? reject(error) : resolve(result);
            });
        });
